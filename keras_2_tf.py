...
if (args.keras_json != ''):
    ...
    try:
        ...
        loaded_model = yolo_body(Input(shape=(None, None, 3)), 3, len(get_classes('./model_data/nuimg_class.txt')))
        loaded_model.load_weights(args.keras_hdf5)
